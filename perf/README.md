...
This test submits transactions which call the `set` method on a [`simplestorage`](https://github.com//kaleido-js/blob/master/deploy-transact/contracts/simplestorage.sol) contract.
